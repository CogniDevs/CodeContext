...
class BadgeButton(QPushButton):
    def __init__(self, text: str, active: bool = True, parent=None):
...
class SettingsDialog(QDialog):
    def __init__(self, config_manager, parent=None):
        ...
        self.setWindowTitle("Настройки CodeContext")
    ...
    def _build_general_tab(self):
        ...
        self.chk_auto_update.setChecked(self.config_manager.get("auto_check_updates", True))
    ...
    def _build_extensions_tab(self):
        ...
        self.combo_presets.setCurrentText(self.config_manager.get("selected_preset", "Все текстовые файлы (без ограничений)"))
