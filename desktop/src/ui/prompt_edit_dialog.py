...
class RuleCardWidget(QFrame):
    def __init__(self, rule_data: dict, on_edit_callback, on_delete_callback, parent=None):
        super().__init__(parent)
...
class PromptCreateDialog(QDialog):
    ...
    def create_custom_rule(self, category_key: str):
    ...
    def on_edit_rule(self, rule_data: dict):
    ...
    def on_delete_rule(self, rule_data: dict):
