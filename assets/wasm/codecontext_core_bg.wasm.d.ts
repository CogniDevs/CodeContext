...
export const sanitize_secrets_wasm: (a: number, b: number) => [number, number];
export const strip_comments_wasm: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
export const trace_dependencies_wasm: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number];
